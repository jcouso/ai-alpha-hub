...
### 🚨 Missing From This Report (added post-publish)

**ChatGPT Ads Go Live (Feb 19)** — Score: 8.5/10 | CONFIRMED
OpenAI launched ads in ChatGPT responses. Expedia, Qualcomm, Best Buy, and Enterprise Mobility are already live — triggering as early as the first prompt. This is a fundamental monetization shift: ChatGPT becomes an ad-supported media channel, not just a subscription tool. Pressure on Google Search intensifies; ad budgets will follow attention.
- **Source:** [Adweek](https://www.adweek.com/media/first-ads-on-chat-gpt-best-buy-expedia-qualcomm/) | [The Verge](https://www.theverge.com/openai)

**Nvidia + OpenAI Investment Deal (Feb 20)** — Score: 7.5/10 | UNVERIFIED
Reports that Nvidia and OpenAI are close to a new major investment deal. No confirmed numbers. If true: deepens the GPU-model axis, gives OpenAI more chip security, and signals Nvidia's bet on the model layer beyond hardware.
- **Source:** [The Verge](https://www.theverge.com/openai)
